...
public class USRegistry {
    ...
    public static final TradeShopBlock BLOCK = register("trade_block", new TradeShopBlock(false, AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(2.8F, 3600000.0F)), Registries.BLOCK);
    public static final TradeShopBlock BLOCK_ADMIN = register("admin_trade_block", new TradeShopBlock(true, AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(-1.0F, 3600000.0F).dropsNothing()), Registries.BLOCK);
