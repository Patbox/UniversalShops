    ...
    public static void build(ModContainer container) {
...

        {
            ...
            try {
                ...
                about.add(TextUtil.text("about.version", Component.literal(container.getMetadata().getVersion().getFriendlyString()).setStyle(Style.EMPTY.withColor(ChatFormatting.WHITE))).setStyle(Style.EMPTY.withColor(0x59b8f7)));
